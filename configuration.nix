 ...
 
{
  ...
  xdg.portal = { 
    enable = true; 
    extraPortals = with pkgs; [ # Set portals for each wm here 
  ...
  services = { 
    ...
    xkb = {
      ...
      displayManager.lightdm = {
        enable = true;
        background = ./wallpapers/black-hole-reddit_decayce.png;
        greeters = {
         slick.enable = true;
         };
        };
  ...
  environment.shellAliases = {
    ...
    rebuild-nix = "doas nix-collect-garbage -d && doas nixos-rebuild switch";
