{ ... }:
                        {
                          wayland.windowManager.mango = {
                            ...
                            borderpx=4
                            rootcolor=0x0a0c0fff
                            bordercolor=0x202529ff
                            focuscolor=0x75aaf0ff
                            maxmizescreencolor=0x6dc799ff
                            urgentcolor=0xe87177ff
                            scratchpadcolor=0x6696d6ff
                            globalcolor=0x75aaf0ff
                            overlaycolor=0x69add4ff
                            ...
                            tagrule=id:4,layout_name:horizontal_scroller
                            ...
                            # Launch Applications
                            bind=SUPER,d,spawn,rofi-menu
                            bind=SUPER,s,spawn,screenshot
                            bind=SUPER,x,spawn,powermenu
                            bind=SUPER,w,spawn,wallpaper-switch
                            bind=SUPER+SHIFT,g,spawn,library
                            bind=SUPER+SHIFT,w,spawn,wifi-menu
                            bind=SUPER,Return,spawn,kitty
                            bind=SUPER+SHIFT,d,spawn,discord
                            bind=SUPER+SHIFT,a,spawn,kitty -e ani-cli
                            bind=SUPER+SHIFT,s,spawn,firefox
                            bind=SUPER+SHIFT,f,spawn,nemo

                            # Volume and Brightness
                            bind=SUPER,n,spawn,volume --up
                            bind=SUPER,m,spawn,volume --down
                            bind=SUPER,b,spawn,volume --toggle
                            bind=ALT,n,spawn,brightness --up
                            bind=ALT,m,spawn,brightness --down
                            ...
                            bind=SUPER,e,minized,
                            bind=SUPER,o,toggleoverlay,
                            bind=SUPER+SHIFT,e,restore_minized
                            ...
                            # switch layout
                            bind=SUPER,backslash,switch_layout
