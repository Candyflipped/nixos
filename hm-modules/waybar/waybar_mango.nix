{config, pkgs, ...}: {
  ...
  programs.waybar = {
    ...
    style = ''
          ...
          /* Dark Decay */
          @define-color foreground #a1a8b3;
          @define-color background #0a0c0f;
          @define-color alt_background #101419;
          @define-color accent #75aaf0;
          @define-color bitcoin #FF9900;

          @define-color black #202529;
          @define-color red #cc575c;
          @define-color green #6dc799;
          @define-color yellow #debf7f;
          @define-color blue #6696d6;
          @define-color magenta #b47ed9;
          @define-color cyan #69add4;
          @define-color white #cbced3;

          @define-color alt_black #282e33; 
          @define-color alt_red #e87177;
          @define-color alt_green #88e3b5;
          @define-color alt_yellow #ebd899;
          @define-color alt_blue #81b2eb;
          @define-color alt_magenta #d099eb;
          @define-color alt_cyan #84c9eb;
          @define-color alt_white #e6e9eb;
      ...
      mainBar = {
        ...
        "group/hardware" = {
          orientation = "horizontal";
	        ...
	        modules = [ "custom/hardware-wrap" "battery" "cpu" "memory" "network" ];
        };

        "custom/hardware-wrap" = {
	      format = "  Resource Usage";
  	    tooltip-format = "General system information";
        };
